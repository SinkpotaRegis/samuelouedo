                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="row g-3 needs-validation" method="POST" action="{{route('back.samuel')}}" novalidate>
                                                      @csrf
                                                      <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                          ...
                                                          <input type="text" name="bom" class="form-control" id="validationCustom01" placeholder="John" required>
                                                          <div class="valid-feedback">
                                                            Looks good!
                                                          </div>
                                                        </div>
                                                ...
                                                <th scope="row">
                                                    <form action="/upload" method="POST" enctype="multipart/form-data" id="imageForm">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="file" name="photo" id="imageForm" class="d-none" onchange="soumettre()" accept="image/*">
